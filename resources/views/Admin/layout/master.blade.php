      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{url('continuous_service')}}"><i class="fa fa-circle-o"></i> Long Term Service Product</a></li>
            <li><a href="{{url('onetime_service')}}"><i class="fa fa-circle-o"></i> One Time Service Product</a></li>
          </ul>
        </li>
